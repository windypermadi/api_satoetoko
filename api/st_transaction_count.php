...
if ($iduser) {
    ...
    $data1 = $conn->query("SELECT count(id_transaksi) as jumlah FROM transaksi WHERE status_transaksi = '1' AND (tanggal_transaksi <= tanggal_exp) AND id_user = '$iduser';")->fetch_object();
